...
import { ClipboardList, Calendar, User, LogOut, Clock, ShieldCheck, Activity, LayoutDashboard } from 'lucide-react';
        ...
        <nav className="doctor-sidebar">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <div className="doctor-sidebar-footer">
                    {/* Timer Widget in Sidebar for visibility, similar to Doctor's quick stats if exists, or just custom addition derived from previous turn */}
                    <div style={{
                        marginBottom: '1rem',
                        padding: '0.75rem',
